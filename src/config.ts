...
export const siteConfig: SiteConfig = {
	...
	banner: {
		...
		src: {
			desktop: [
				"/assets/desktop-banner/kon1.png",
				"/assets/desktop-banner/kon2.png",
				"/assets/desktop-banner/kon3.png",
				"/assets/desktop-banner/kon4.png",
		...
		homeText: {
			...
			title: "Kon Mizuki!", // 主页横幅主标题

			subtitle: ["K-on forever!!!!!"],
			typewriter: {
	...
	links: [
		...
		// 支持自定义导航栏链接,并且支持多级菜单,3.1版本新加
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/turnsup",
					external: true,
					icon: "fa6-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/320866305",
					external: true,
